...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoadmapSettings.anyone_can_edit'
        db.add_column(u'roadmaps_roadmapsettings', 'anyone_can_edit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoadmapSettings.anyone_can_edit'
        db.delete_column(u'roadmaps_roadmapsettings', 'anyone_can_edit')
