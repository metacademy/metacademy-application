...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'graph_tag', 'id', self.gf('django.db.models.fields.CharField')(max_length=30, primary_key=True))

        # Changing field 'Tag.title'
        db.alter_column(u'graph_tag', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Tag.id'
        db.alter_column(u'graph_tag', 'id', self.gf('django.db.models.fields.CharField')(max_length=16, primary_key=True))

        # Changing field 'Tag.title'
        db.alter_column(u'graph_tag', 'title', self.gf('django.db.models.fields.CharField')(max_length=16))
