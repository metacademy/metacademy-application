...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Concepts'
        db.create_table(u'user_management_concepts', (
            ('id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10, primary_key=True)),
        ))
        db.send_create_signal(u'user_management', ['Concepts'])

        # Adding M2M table for field learned_uprofs on 'Concepts'
        m2m_table_name = db.shorten_name(u'user_management_concepts_learned_uprofs')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('concepts', models.ForeignKey(orm[u'user_management.concepts'], null=False)),
            ('profile', models.ForeignKey(orm[u'user_management.profile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['concepts_id', 'profile_id'])

        # Adding M2M table for field starred_uprofs on 'Concepts'
        m2m_table_name = db.shorten_name(u'user_management_concepts_starred_uprofs')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('concepts', models.ForeignKey(orm[u'user_management.concepts'], null=False)),
            ('profile', models.ForeignKey(orm[u'user_management.profile'], null=False))
    ...
    def backwards(self, orm):
        # Deleting model 'Concepts'
        db.delete_table(u'user_management_concepts')

        # Removing M2M table for field learned_uprofs on 'Concepts'
        db.delete_table(db.shorten_name(u'user_management_concepts_learned_uprofs'))

        # Removing M2M table for field starred_uprofs on 'Concepts'
        db.delete_table(db.shorten_name(u'user_management_concepts_starred_uprofs'))
