...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Roadmap.version_num'
        db.add_column(u'roadmaps_roadmap', 'version_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Roadmap.version_num'
        db.delete_column(u'roadmaps_roadmap', 'version_num')
    ...
    models = {
        ...
        u'roadmaps.roadmap': {
            'Meta': {'unique_together': "(('user', 'url_tag'),)", 'object_name': 'Roadmap'},
