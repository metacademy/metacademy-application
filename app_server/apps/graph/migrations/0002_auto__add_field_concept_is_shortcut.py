...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Concept.is_shortcut'
        db.add_column(u'graph_concept', 'is_shortcut',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Concept.is_shortcut'
        db.delete_column(u'graph_concept', 'is_shortcut')
