...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoadmapSettings.sudo_listed_in_main'
        db.add_column(u'roadmaps_roadmapsettings', 'sudo_listed_in_main',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoadmapSettings.sudo_listed_in_main'
        db.delete_column(u'roadmaps_roadmapsettings', 'sudo_listed_in_main')
