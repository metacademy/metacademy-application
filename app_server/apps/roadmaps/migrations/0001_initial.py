...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'roadmaps_roadmap', (
            ...
            ('audience', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('visibility', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'roadmaps', ['Roadmap'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'roadmaps_roadmap')
    ...
    models = {
        ...
        u'roadmaps.roadmap': {
            ...
            'visibility': ('django.db.models.fields.CharField', [], {'max_length': '20'})
        }
    }
