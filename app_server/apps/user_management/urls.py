...
urlpatterns = patterns('',
                       ...
                       url(r'^password_reset$', password_reset, {'template_name': 'user_management/password_reset_form.html',
                       ...
                       url('^password_reset/sent$', password_reset_complete, {'template_name': "user_management/password_reset_complete.html"}, name="password_reset_complete"),
                       url(r'^password_reset/(?P<uidb36>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',
