...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('graph', '0003_auto__add_tag__add_field_goal_ordering__add_field_goal_last_mod__add_f'),
        )

    def forwards(self, orm):
        # Adding M2M table for field tags on 'Roadmap'
        m2m_table_name = db.shorten_name(u'roadmaps_roadmap_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('roadmap', models.ForeignKey(orm[u'roadmaps.roadmap'], null=False)),
            ('tag', models.ForeignKey(orm[u'graph.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['roadmap_id', 'tag_id'])
